        ...
        <div className="about-flex-row">
          <div className="about-flex-content">
            ...
            <p>
              ...
              Design. Inspired and encouraged by an amazing professor I
              continued with my quest which first took me to Finnish Lapland and
              then London, where a serendipitous meeting with glassmaker Anthony
              Stern changed my life forever. I began as an apprentice in his
              studio and after a spellbinding year of interning with him, I
              moved on to The Glasshouse, a co-operative of 4 glassmakers based
              in Covent Garden, London. There I had the opportunity to further
              explore the medium - observing, learning and working with diverse
              artists and their individual styles and techniques.
            </p>
            <p>
              ...
              annealing oven, the blowing irons to the workbench, from the
              cullet to the colour, every piece of equipment was constructed
              indigenously, and every scrap of raw material sourced locally. My
              first studio space was a rented tin shed in the heart of the city,
              a few kilometres from my home. Approximately 500 sq ft, it was at
              the end of an unpaved lane which also housed a couple of taxi
              repair garages. Over a decade later, I shifted my studio into a
              small house nearby, allowing me to continue to expand, develop and
              experiment with my art form.
            </p>
            <p>
              My work is inspired by my passion for both functional art as well
              as for the vessel form - a creative combination of form with
              function, craft with art. The vessel for me is a vehicle to bring
              to expression my ideas and feelings. It exists to hold or contain,
              both literally and metaphorically and is all encompassing in its
            ...
            <p>
              The spontaneity and impulsiveness of blowing glass suits my
              nature. To me, it is an interactive negotiation between the
              material and the maker, a compromise between what you want and
              what the glass dictates. My personal approach to making is purely
              organic - I work directly with the glass and in essence allow the
              ideas to flow as I blow! While I can control the line and colour
              of any given piece, the resulting form is ultimately a
              collaboration between my blowing skills and the forces of nature.
            </p>
            {/*Signature Image*/}
